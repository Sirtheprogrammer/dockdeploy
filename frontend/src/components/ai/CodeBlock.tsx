...
export function CodeBlock({ language, code }: CodeBlockProps) {
  ...
  return (
    <div className="group bg-zinc-950 my-2.5 overflow-hidden rounded-lg border border-zinc-800 text-xs font-mono">
      ...
      <pre className="scrollbar-thin overflow-x-auto p-3 text-zinc-200 leading-relaxed">
        <code>{code}</code>
      </pre>
    </div>
  )
